...
class LogicOperatorPage extends StatelessWidget {
              ...
              Row(
                ...
                children: [
                  ...
                  CalculatorButton(
                    ...
                    onPressed: () => calculatorBloc.add(OperationEntry('AND')),
                  ),
                  CalculatorButton( 
                    text: 'OR',
                    bgColor: Color(0xffF0A23B ),
                    onPressed: () => calculatorBloc.add(OperationEntry('OR')),
                  ),
                  CalculatorButton( 
                    text: 'XOR',
                    bgColor: Color(0xffF0A23B ),
                    onPressed: () => calculatorBloc.add(OperationEntry('XOR')),
                  ),
                  CalculatorButton( 
                    text: '=',
                    bgColor: Color(0xffF0A23B ),
